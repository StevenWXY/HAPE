const works = [
  {
    id: 'work-water',
    title: 'HAPW水浒',
    titleEn: 'HAPW Water Margin',
    titleKo: 'HAPW 수호전',
    category: '国风叙事',
    categoryEn: 'Folk narrative',
    categoryKo: '전통 서사',
    duration: '00:58',
    views: 128400,
    creator: 'Clipli创作组',
    ...
    format: 'AI 动画短片',
    formatEn: 'AI animated short',
    formatKo: 'AI 애니메이션 단편',
    linkedAssetId: 'asset-528',
    haiwenUrl: 'https://hnccc.hzbcm.com/',
    accent: 'coral',
    source: 'seed'
  },
  {
    id: 'work-signal',
    title: '夜航者：零点信号',
    titleEn: 'Night Flyers: Zero Signal',
    titleKo: '야간 비행자: 0시 신호',
    category: '科幻短剧',
    categoryEn: 'Sci-fi short',
    categoryKo: 'SF 숏드라마',
    duration: '01:24',
    views: 86200,
    creator: 'MINTLAB',
    creatorEn: 'MINTLAB',
    creatorKo: 'MINTLAB',
    summary: '从一枚失联 NFT 发出的频率，穿过城市上空。',
    summaryEn: 'A frequency from a lost NFT crosses the city skyline.',
    summaryKo: '연결이 끊긴 NFT가 보낸 주파수가 도시의 밤하늘을 가로지른다.',
    ...
    format: '科幻微短剧',
    formatEn: 'Sci-fi micro series',
    formatKo: 'SF 마이크로 시리즈',
    linkedAssetId: 'asset-771',
    haiwenUrl: 'https://hnccc.hzbcm.com/',
    accent: 'amber',
    source: 'seed'
  },
  {
    id: 'work-tide',
    title: '海风计划：登陆',
    titleEn: 'Sea Breeze: Landing',
    titleKo: '바닷바람 프로젝트: 상륙',
    category: '冒险',
    ...
    creatorEn: 'Mori',
    creatorKo: 'Mori',
    summary: 'HAPW #2048 的首支资产叙事短片，向未知海岸出发。',
    summaryEn: 'The first asset story for HAPW #2048 heads for an unknown shore.',
    summaryKo: 'HAPW #2048의 첫 자산 서사가 미지의 해안으로 향한다.',
    ...
    format: '资产叙事短片',
    formatEn: 'Asset story short',
    formatKo: '자산 서사 단편',
    linkedAssetId: 'asset-2048',
    haiwenUrl: 'https://hnccc.hzbcm.com/',
    accent: 'teal',
    source: 'seed'
  },
  {
    ...
    creatorEn: 'Kite',
    creatorKo: 'Kite',
    summary: '一段关于离开、回望与重新拥有的等距叙事。',
    summaryEn: 'An isometric story about leaving, looking back and owning again.',
    summaryKo: '떠남과 회상, 다시 소유하는 일을 다룬 아이소메트릭 서사.',
    description: '一座空间站在最后一次换轨前开放旧物寄存。人们留下的不只是物件，也包括一段可被授权、转移和重新讲述的记忆。',
    descriptionEn: 'Before its final orbital change, a station opens an archive for old belongings. People leave behind objects and memories that can be licensed, transferred and retold.',
    descriptionKo: '마지막 궤도 변경을 앞둔 우주 정거장이 오래된 물건을 보관하는 기록소를 연다. 사람들은 물건뿐 아니라 허가하고 이전하며 다시 이야기할 수 있는 기억도 남긴다.',
    format: '实验动画',
    formatEn: 'Experimental animation',
    formatKo: '실험 애니메이션',
    linkedAssetId: 'asset-332',
    haiwenUrl: 'https://hnccc.hzbcm.com/',
    accent: 'gold',
    source: 'seed'
  }
...
const clip = {
  ...
  acquisition: '核销 HAPW 时领取，也可通过外部 DEX 购买',
  acquisitionEn: 'Granted when HAPW is redeemed or purchased through an external DEX',
  acquisitionKo: 'HAPW 상각 시 지급되거나 외부 DEX에서 구매',
  quoteAsset: 'USDT',
  pricePolicy: '由外部 DEX 流动性决定，不固定锚定',
  pricePolicyEn: 'Market-priced by external DEX liquidity; no fixed peg',
  pricePolicyKo: '외부 DEX 유동성에 따른 시장 가격, 고정 페그 없음',
  contractStatus: '正式合约信息待发布',
...
const generations = [
  {
    ...
    assetId: 'asset-903',
    title: '低语岛：潮汐试片',
    titleEn: 'Whisper Island: Tide Test',
    titleKo: '속삭임의 섬: 조수 테스트',
    duration: 15,
    quality: 'pro',
    creditsUsed: 23,
    validViews: 18600,
...
const profile = {
  wallet: '',
  walletProvider: '',
  overseasAccount: 'HWF-8391',
  phone: '138****1024',
  level: 3,
  points: 3460,
  settings: { walletSign: true, expiryReminder: true }
};
