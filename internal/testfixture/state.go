...
func SeedState() State {
	...
	assets := []domain.HAPWAsset{
		seedAsset("asset-2048", "#2048", "海风计划", "Sea Breeze", "바닷바람 프로젝트", 18800, "可核销", "Redeemable", "상각 가능", true, "海风计划版权方", "Sea Breeze rights holder", "바닷바람 프로젝트 저작권자", "角色、场景与叙事元素的 AI 视频改编", "AI video adaptation of characters, scenes and story elements", "캐릭터, 장면 및 서사 요소의 AI 영상 각색", 150, 520, false, "available", []string{"work-tide"}, "2026-05-12"),
...
func seedAsset(id, tokenID, name, nameEn, nameKo string, value int, status, statusEn, statusKo string, transferable bool, holder, holderEn, holderKo, scope, scopeEn, scopeKo string, creditYield, clipPrice int, exchangeAvailable bool, redemptionStatus string, workIDs []string, issuedAt string) domain.HAPWAsset {
	...
	return domain.HAPWAsset{
		...
		External: domain.ExternalAssetRef{TransferID: "test-transfer-" + id, ProviderCode: providerCode, ProviderAssetID: providerAssetID, AssetURL: assetURL, SyncStatus: "migrated", LastSyncedAt: "2026-08-18T08:30:00Z", DataVersion: "snapshot-2026-08-18"},
	}
}
