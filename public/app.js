...
const translations = {
  zh: {
    ...
    rightsTitle: "CLIP 是平台积分", rightsText: "CLIP 总量一次性铸造并由平台金库托管，按公开规则分发，主要用于生成费用、授权手续费和服务兑换。用户可通过外部 DEX 取得，余额与每一次使用都会在仪表盘中留下记录。",
    ...
    clipPolicyTitle: "机制边界", supplyPolicyTitle: "发行", supplyPolicyText: "CLIP 总量一次性铸造，后续不增发。平台把代币存放在金库，并按公开规则分发，每次变动都保留记录。", usagePolicyTitle: "用途", usagePolicyText: "当前用于 AI 视频生成、授权手续费、本地化服务和平台服务兑换。", recyclePolicyTitle: "回流", recyclePolicyText: "生成费和兑换手续费回到平台金库，用于运营与后续服务；不承诺销毁或固定回购。", disclosurePolicyTitle: "披露", disclosurePolicyText: "正式上线前应公开网络、合约地址、流动性池、一次性铸造记录和分发规则。", clipDemoNotice: "当前为功能演示。正式 CLIP 合约与网络尚未配置，请勿仅凭页面名称进行任何兑换。",
  ...
  en: {
    ...
    rightsTitle: "CLIP is the platform point", rightsText: "CLIP is minted once and held in the platform treasury, then distributed under published rules. It supports generation fees, licenses and service exchange; external DEX acquisition remains visible in the dashboard.",
    ...
    clipPolicyTitle: "Mechanism boundaries", supplyPolicyTitle: "Issuance", supplyPolicyText: "CLIP is minted once with a fixed total supply. The platform holds it in treasury and distributes it under published rules, retaining every movement.", usagePolicyTitle: "Utility", usagePolicyText: "Current uses include AI generation, license fees, localization and platform service exchange.", recyclePolicyTitle: "Return flow", recyclePolicyText: "Generation and exchange fees return to the platform treasury for service accounting. There is no promised burn or fixed buyback.", disclosurePolicyTitle: "Disclosure", disclosurePolicyText: "Before launch, Clipli should publish the network, contract, liquidity pool, one-time mint record and distribution rules.", clipDemoNotice: "This is a functional demo. The official CLIP contract and network are not configured. Do not swap based on the token name alone.",
